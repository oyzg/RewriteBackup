...
^https:\/\/buy\.itunes\.apple\.com\/verifyReceipt url script-response-body https://raw.githubusercontent.com/oyzg/RewriteBackup/main/itunes/baiban.js
    ...
    "in_app": [
      {
        ...
        "product_id": "cn.readpad.tool.iwhiteboard.coffee006",//这里替换成你要解锁的容量id
  ...
  "pending_renewal_info": [
    {
      "product_id": "cn.readpad.tool.iwhiteboard.coffee006",//这里替换成你要解锁的容量id
      "original_transaction_id": "220002179016924",
      "auto_renew_product_id": "cn.readpad.tool.iwhiteboard.coffee006",//这里替换成你要解锁的容量id
      "auto_renew_status": "1"
    }
  ],
  "status": 0,
