 ...
 * bojxs地址https://raw.githubusercontent.com/oyzg/RewriteBackup/refs/heads/main/boxjs.json

[rewrite_local]
https:\/\/bp-api\.bestv\.com\.cn\/cms\/api\/(live\/studio\/id\/v4|c\/player\/common) url script-response-body https://raw.githubusercontent.com/oyzg/RewriteBackup/refs/heads/main/kdf.js
...
const c = $.getdata("scheme")
if (!c) {
    console.log("未设置 Scheme");
}
if (a.includes("player/common") && $response.body) {
    try {
        ...
        if (e && e.qualitys) {
            ...
            if (f && (f.originalUrl || f.qualityUrl)) {
                ...
                let k;
                if (c === "SenPlayer") {
                    k = "SenPlayer://x-callback-url/play?url=" + encodeURIComponent(h);
                } else if (c === "Safari") {
                    k = h;
                } else {
...
// 影视
if (a.includes("i/live/studio/id/v4") && $response.body) {
    try {
        const d = JSON.parse($response.body);
        const e = d.dt.liveStudioStreamRelVoList;
